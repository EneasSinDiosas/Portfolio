...
export const CardDay: FC<CardDayProps> = ({day}) =>{
    ...
    return (
        <div className='flex flex-col text-start bg-amber-200 items-center rounded-xl px-16 m-10 shadow-lg'>
            <h1 className='text-lg text-orange-600 font-bold antialiased tracking-widest'>{day?.date}</h1>
