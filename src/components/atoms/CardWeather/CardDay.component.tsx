...
export const CardDay: FC<CardDayProps> = ({day}) =>{
    ...
    return (
        <div className='flex flex-col text-start bg-emerald-50 bg-opacity-20 items-center rounded-xl px-16 m-10 shadow-lg'>
            <h1 className='text-lg text-green-200 text-opacity-80 font-bold antialiased tracking-widest'>{day?.date}</h1>
